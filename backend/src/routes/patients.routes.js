...
router.get('/me/export-pdf', authorize('patient'), sensitiveDataLimiter, exportMyMedicalPdf);
...
router.get('/:id/export-pdf', authorize('doctor', 'nurse', 'admin', 'patient'), sensitiveDataLimiter, checkResourceAccess('patient'), exportMedicalPdf);
