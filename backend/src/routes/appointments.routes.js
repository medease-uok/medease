...
const { getAll, getById, create, createRecurring, cancelSeries, updateStatus, cancelAppointment, reschedule } = require('../controllers/appointments.controller');
...
router.delete('/:id', requirePermission('update_appointment_status', 'cancel_appointment'), cancelAppointment);
