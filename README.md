...
- Inventory management for hospital supplies and equipment with low stock alerts, expiry date tracking, admin notifications, reorder quantity suggestions, and transaction audit logs for admins
